// IIFE wrapper: abc2svg defines a local `function Symbol()` which would
// overwrite the built-in ES6 Symbol and break Angular.  We execute the
// entire file inside a closure so that `Symbol` stays local, then
// re-export the abc2svg globals that the application needs.
(function(_originalSymbol) {
...
// @volume: range [0..1] - undefined = return current value
    ...
    var	abcsf2 = window.abcsf2 = []		// SF2 instruments (exposed globally for dynamic script loading)
...
// End of IIFE wrapper — export needed globals to window
window.abc2svg = abc2svg;
window.Abc = abc2svg.Abc;
window.AbcPlay = typeof AbcPlay !== 'undefined' ? AbcPlay : undefined;
window.AbcMIDI = typeof AbcMIDI !== 'undefined' ? AbcMIDI : undefined;
window.ToAudio = typeof ToAudio !== 'undefined' ? ToAudio : undefined;
window.Audio5 = typeof Audio5 !== 'undefined' ? Audio5 : undefined;
window.Midi5 = typeof Midi5 !== 'undefined' ? Midi5 : undefined;
window.Psvg = typeof Psvg !== 'undefined' ? Psvg : undefined;
}).call(window, window.Symbol);
